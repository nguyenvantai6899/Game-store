...
public class CartController {
    ...
    public Result removeAllProductFromCart(@RequestParam("email") String email){
        return new Result(true, HttpStatus.OK, "Success",cartService.removeALlProductFromCart(email));
    }
